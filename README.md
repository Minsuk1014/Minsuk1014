...
- ⚡ Fun fact: ...
-->
<img src="https://capsule-render.vercel.app/api?type=wave&color=auto&height=300&section=header&text=git%20history&fontSize=90" />
...
### Computer Vision & LLM
- **Feel Check APP** [2024.03 ~ 2024.06]  
  → 표정 분석 기반 감정 일기 앱 개발
...
- **부트캠프 이탈자 예측 분석 [ 2025.07.10 ~ 2025.07.11 ]**
    - 데이콘 부트캠프 데이터를 사용하여 데이터 전처리와 머신러닝을 이용해 이탈자 예측

### Other

- **TACO (타자로 코딩하자)** [2024.04 ~ 2024.06]  
  → 코드 타자 연습 웹사이트 개발  

- **Pixel Guardians APP** [2024.09 ~ 2024.12]  
  → 2D 타워 디펜스 게임 개발

## 🤝 My Projects
  
  - **야구 선수 정보 검색 사이트[ 2025.05.20 ~ 2023.05.20 ]**
      - 크롤링과 데이터 베이스를 활용해 제작
      - 이름 또는 팀 입력 시 선수 정보 제공
        
  - **주식 시세 차트 비교 사이트 [ 2025.06.02 ~ 2023.06.02 ]**
      - 크롤링과 데이터 베이스를 활용해 제작
      - 주식 코드나 주식 이름을 입력하면 시세 차트 제공
        
  - **스쿼트 도우미 프로그램  [ 2025.07.04 ~ 2023.07.05 ]**
      - 컴퓨터 비전 모델과 openCV를 활용해 스쿼트 시 갯수 세어주는 프로그램
        
  - **감성분석 디스코드 봇 제작 [ 2025.07.19 ~ 2025.07.19 ]**
